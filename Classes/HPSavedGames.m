...
- (void)setName:(NSString *)n {
	name = n;
	[[NSNotificationCenter defaultCenter] postNotification:[NSNotification notificationWithName:@"fileNameChosen" object:name]];
}
#pragma mark -
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *filename = [self.games objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	 ...
	 */
	self.name = [self.games objectAtIndex:indexPath.row];
}
